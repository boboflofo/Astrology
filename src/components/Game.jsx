...
const GameForm = () => {
  ...
  const fetchAstrologyData = async () => {
    try {
      const response = await fetch(`astrologyapi-solution.onrender.com/api/signs?expression=${userAnswers[0]}&description=${userAnswers[1]}&concentration=${userAnswers[2]}`);
